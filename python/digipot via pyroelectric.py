...
try:
    ...
    while True:
        ...
        if A_triggered and B_triggered==False:
            TriggeredAllFalse()
            print("1st input：A==Rising,B==0,wait for 2nd input。。")
            #第二次循环
            while True:
                time.sleep(0.1)
            #检测第二次输入BCD，循环2
        ...
        #检测第一次输入为编码器输入eA
        elif encoder.eA_triggered and encoder.eB_triggered==False:
        ...
        #检测第一次循环输入为eB
        elif encoder.eB_triggered and encoder.eA_triggered==False:
    ...
    #第三次输入为A下降                                
                    ...
                    break #退出第二层循环           
#第二次输入为B下降
                elif encoder.eB_triggered==False:
                    print("入力2==B fall")
                    print("入力1に戻る，入力1を待っている。。。")
                    break #退出第二次循环               
